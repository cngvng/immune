...
for i in range(len(data)):
    age = data['Age'][i + 71]
    if age > 70:
        age_group_lst.append('> 70')
    else:
        age_group_lst.append('50-70')
...
fig_name = "./figs/task_1/sepsis_age/data1_sepsis_age_percent.png"
...
fig_name = "./figs/task_1/sepsis_age/data1_sepsis_age_cells.png"
plot_title = "Dataset 1 - Total cell count"
...
fig_name = "./figs/task_1/sepsis_age/data2_sepsis_age_percent.png"
...
fig_name = "./figs/task_1/sepsis_age/data3_sepsis_age_percent_small.png"
...
fig_name = "./figs/task_1/sepsis_age/data4_sepsis_age_percent.png"
...
rotation = 10
fig_name = "./figs/task_1/sepsis_age/data4_sepsis_age_percent_first.png"
plot_boxplot_and_swarmplot(data4, columns_first, identifier_vars, value_name, plot_title, show_outlier, fig_name,
                           rotation)

rotation = 30
fig_name = "./figs/task_1/sepsis_age/data4_sepsis_age_percent_second.png"
...
fig_name = "./figs/task_1/sepsis_age/data5_sepsis_age_percent.png"
...
fig_name = "./figs/task_1/sepsis_age/data6_sepsis_age_percent.png"
...
fig_name = "./figs/task_1/sepsis_age/data6_sepsis_age_mfi.png"
...
fig_name = "./figs/task_1/sepsis_age/data6_sepsis_age_mfi_p44.png"
...
fig_name = "./figs/task_1/sepsis_age/data7_sepsis_age_percent.png"
