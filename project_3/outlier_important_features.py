...
data = data[['Lympho.2', 'Mono', 'Lympho.4', 'Lympho.3', 'Abs CD3', 'Lympho.6',
        'Abs CD8', 'Abs Lympho', 'Abs CD4']]
...
df.to_excel('./figs/task_2/patiences_sepsis_important_features_anomaly.xlsx') 
#df.to_excel('./figs/task_2/patiences_healthy_important_features_anomaly.xlsx')
