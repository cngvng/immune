...
#df.to_excel('./results/task_2/healthy_age/patiences_healthy_age_17-30_anomaly.xlsx')
#df.to_excel('./results/task_2/healthy_age/patiences_healthy_age_31-45_anomaly.xlsx')
df.to_excel('./results/task_2/healthy_age/patiences_healthy_age_over_45_anomaly.xlsx')
