...
df.to_excel("./results/task_3/age/important_features_healthy_age.xlsx")
...
fig_name = "./results/task_3/age/key_features_percent.png"
...
if len(features_selected_cells) > 1:
    # only for healthy
    fig_name = "./results/task_3/age/key_features_cell.png"
