...
df.to_excel("./results/task_3/gender_elderly/important_features_healthy_gender_elderly.xlsx")
...
fig_name = "./results/task_3/gender_elderly/key_features_percent_elderly.png"
...
if len(features_selected_cells) > 1:
    # only for healthy
    fig_name = "./results/task_3/gender_elderly/key_features_cell_elderly.png"
